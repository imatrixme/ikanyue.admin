...
export const resourceFormFields: Partial<Record<OpsResource, ResourceFormField[]>> = {
  ...
  learningSessions: [
    { key: 'programId', label: '所属班级/课包', type: 'relation', relation: 'learningPrograms' },
  ...
  programStudents: [
    { key: 'programId', label: '班级/课包', type: 'relation', relation: 'learningPrograms' },
  ...
  reportEvents: [
    ...
    { key: 'scopeType', label: '报告范围', type: 'select', options: labeledOptions({ program: '班级/课包', session: '课堂', activity: '活动', custom: '自定义' }) },
