...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { view: 'programStudents', label: '项目学员', icon: GraduationCap, section: '高级维护' },
      { view: 'programTeachers', label: '项目教师', icon: Users, section: '高级维护' },
      { view: 'sessionStudents', label: '课次学员', icon: ClipboardCheck, section: '高级维护' },
      { view: 'sessionTeachers', label: '课次教师', icon: Users, section: '高级维护' },
    ],
  },
  {
    key: 'content',
