  ...
  return (
    <Panel className="min-w-0 overflow-hidden">
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-[var(--border)] px-5 py-4">
        <div><h2 className="text-lg font-semibold">学员管理</h2><p className="mt-1 text-sm text-[var(--muted-foreground)]">维护积分系统使用的学员基本信息。</p></div>
      ...
      <div className="grid gap-3 border-b border-[var(--border)] bg-[var(--muted)]/35 px-4 py-4 md:grid-cols-[minmax(220px,1fr)_160px_180px]">
